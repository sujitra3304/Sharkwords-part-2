...
const handleCorrectGuess = (letter) => {
  ...
  if (isLetterInWord(letter) === true) {
    const letterDivsContainer = document.querySelector(`div.${letter}`);
    letterDivsContainer.insertAdjacentHTML('beforeend', `${letter}`);
  }
};
...
(function startGame() {
  ...
  button.addEventListener('click', () => {
    const letter = evt.target.innerHTML;  // can also use evt.target instead of button
